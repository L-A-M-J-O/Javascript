...
const url100= 'https://pokeapi.co/api/v2/pokemon/260/'
fetch (url100)
.then(response => response.json())
.then (data => {

    let btn = document.getElementById ('elem100')
    btn.innerHTML = `
    <h1 class="mt-4">${data.name}</h1>
    <img src='${data.sprites.front_default}'>
    `;
...
const url101= 'https://pokeapi.co/api/v2/pokemon/210/'
fetch (url101)
.then(response => response.json())
.then (data => {

    let btn = document.getElementById ('elem101')
    btn.innerHTML = `
    <h1 class="mt-4">${data.name}</h1>
    <img src='${data.sprites.front_default}'>
    `;
...
const url102= 'https://pokeapi.co/api/v2/pokemon/280/'
fetch (url102)
.then(response => response.json())
.then (data => {

    let btn = document.getElementById ('elem102')
    btn.innerHTML = `
    <h1 class="mt-4">${data.name}</h1>
    <img src='${data.sprites.front_default}'>
    `;
...
const url103= 'https://pokeapi.co/api/v2/pokemon/281/'
fetch (url103)
.then(response => response.json())
.then (data => {

    let btn = document.getElementById ('elem103')
    btn.innerHTML = `
    <h1 class="mt-4">${data.name}</h1>
    <img src='${data.sprites.front_default}'>
    `;
...
const url104= 'https://pokeapi.co/api/v2/pokemon/203/'
fetch (url104)
.then(response => response.json())
.then (data => {

    let btn = document.getElementById ('elem104')
    btn.innerHTML = `
    <h1 class="mt-4">${data.name}</h1>
    <img src='${data.sprites.front_default}'>
    `;
...
const url105= 'https://pokeapi.co/api/v2/pokemon/209/'
fetch (url105)
.then(response => response.json())
.then (data => {

    let btn = document.getElementById ('elem105')
    btn.innerHTML = `
    <h1 class="mt-4">${data.name}</h1>
    <img src='${data.sprites.front_default}'>
    `;
...
const url106= 'https://pokeapi.co/api/v2/pokemon/299/'
fetch (url106)
.then(response => response.json())
.then (data => {

    let btn = document.getElementById ('elem106')
    btn.innerHTML = `
    <h1 class="mt-4">${data.name}</h1>
    <img src='${data.sprites.front_default}'>
    `;
...
const url107= 'https://pokeapi.co/api/v2/pokemon/306/'
fetch (url107)
.then(response => response.json())
.then (data => {

    let btn = document.getElementById ('elem107')
    btn.innerHTML = `
    <h1 class="mt-4">${data.name}</h1>
    <img src='${data.sprites.front_default}'>
    `;
...
const url108= 'https://pokeapi.co/api/v2/pokemon/369/'
fetch (url108)
.then(response => response.json())
.then (data => {

    let btn = document.getElementById ('elem108')
    btn.innerHTML = `
    <h1 class="mt-4">${data.name}</h1>
    <img src='${data.sprites.front_default}'>
    `;
